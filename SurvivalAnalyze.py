...
cur.execute('''DROP TABLE IF EXISTS Probability''')
cur.execute('''CREATE TABLE IF NOT EXISTS Probability(Event TEXT,probability FLOAT)''')
...
people_surviving=(count/len(allpassengers))*100
male_surviving=(countm/len(allpassengers))*100
female_surviving=(countff/len(allpassengers))*100
first_class_surviving=(first_survived/len(allpassengers))*100
second_class_surviving=(second_survived/len(allpassengers))*100
third_class_surviving=(third_survived/len(allpassengers))*100
first_class_male_surviving=(m1/len(allpassengers))*100
second_class_male_surviving=(m2/len(allpassengers))*100
third_class_male_surviving=(m3/len(allpassengers))*100
first_class_female_surviving=((first_survived-m1)/len(allpassengers))*100
second_class_female_surviving=((second_survived-m2)/len(allpassengers))*100
third_class_female_surviving=((third_survived-m3)/len(allpassengers))*100
young_surviving=(count_young/len(allpassengers))*100
adult_surviving=(count_adult/len(allpassengers))*100
aged_surviving=(count_aged/len(allpassengers))*100
print(people_surviving)
...
cur.execute(f'''INSERT OR IGNORE INTO Probability(Event,probability) VALUES (?,?)''',('people',people_surviving))
cur.execute(f'''INSERT OR IGNORE INTO Probability(Event,probability) VALUES (?,?)''',('male',male_surviving))
cur.execute(f'''INSERT OR IGNORE INTO Probability(Event,probability) VALUES (?,?)''',('female',female_surviving))
cur.execute(f'''INSERT OR IGNORE INTO Probability(Event,probability) VALUES (?,?)''',('first_class',first_class_surviving))
cur.execute(f'''INSERT OR IGNORE INTO Probability(Event,probability) VALUES (?,?)''',('second_class',second_class_surviving))
cur.execute(f'''INSERT OR IGNORE INTO Probability(Event,probability) VALUES (?,?)''',('third_class',third_class_surviving))
cur.execute(f'''INSERT OR IGNORE INTO Probability(Event,probability) VALUES (?,?)''',('first_class_male',first_class_male_surviving))
cur.execute(f'''INSERT OR IGNORE INTO Probability(Event,probability) VALUES (?,?)''',('second_class_male',second_class_male_surviving))
cur.execute(f'''INSERT OR IGNORE INTO Probability(Event,probability) VALUES (?,?)''',('third_class_male',third_class_male_surviving))
cur.execute(f'''INSERT OR IGNORE INTO Probability(Event,probability) VALUES (?,?)''',('first_class_female',first_class_female_surviving))
cur.execute(f'''INSERT OR IGNORE INTO Probability(Event,probability) VALUES (?,?)''',('second_class_female',second_class_female_surviving))
cur.execute(f'''INSERT OR IGNORE INTO Probability(Event,probability) VALUES (?,?)''',('third_class_female',third_class_female_surviving))
cur.execute(f'''INSERT OR IGNORE INTO Probability(Event,probability) VALUES (?,?)''',('young',young_surviving))
cur.execute(f'''INSERT OR IGNORE INTO Probability(Event,probability) VALUES (?,?)''',('adult',adult_surviving))
cur.execute(f'''INSERT OR IGNORE INTO Probability(Event,probability) VALUES (?,?)''',('aged',aged_surviving))
conn.commit()
